...
namespace Pinwheel.Griffin.URP
{
    public static class GGriffinUrpInstaller
    {
        ...
        public static void Install()
        {
            ...
            GRuntimeSettings.Instance.foliageRendering.urpGrassLod1Material = resources.GrassLod1Material;
        ...
        public static void UpgradeTerrainMaterialInProject()
        {
            ...
            Material[] demoMaterials = GEditorSettings.Instance.demoAssets.GetDemoMaterials();
            if (demoMaterials != null)
            {
                for (int i = 0; i < demoMaterials.Length; ++i)
                {
                    ...
                    if (mat != null)
                    {
                        ...
                        {
                            Debug.Log($"POLARIS: Upgrade {mat.name} to URP Lit");
                        ...
                        else if (mat.shader.name.Equals("Polaris/BuiltinRP/Foliage/TreeBillboard"))
                        {
                            Debug.Log($"POLARIS: Upgrade {mat.name} to URP_TreeBillboard_SG");
                            mat.shader = Shader.Find("Polaris/URP/Foliage/URP_TreeBillboard_SG");
                        }
                    }
                }
            }
