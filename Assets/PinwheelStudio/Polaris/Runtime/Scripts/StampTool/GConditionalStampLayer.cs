...
namespace Pinwheel.Griffin.StampTool
{
    ...
    {
        public interface IHasSplatWeightRule
        {
            bool BlendSplatWeight { get; set; }
            int SplatWeightIndex { get; set; }
            AnimationCurve SplatWeightRemap { get; set; }
            Texture2D GetSplatWeightRemapTexture();
        }
        ...
        public virtual void UpdateCurveTextures()
        {
            CleanUp();
