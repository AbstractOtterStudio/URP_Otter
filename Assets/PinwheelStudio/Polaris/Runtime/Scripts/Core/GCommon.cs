...
namespace Pinwheel.Griffin
{
    ...
    public static class GCommon
    {
        ...
        public const string BUSINESS_EMAIL = "pinwheel.customer@gmail.com";
        public const string YOUTUBE_CHANNEL = "https://www.youtube.com/channel/UCebwuk5CfIe5kolBI9nuBTg";
        public const string ONLINE_MANUAL = "https://docs.google.com/document/d/1rbHv8CW_QoHdCEaj98xq_V4S_gdWbbmY9-kQGM8qnpM/edit?usp=sharing";
        public const string FACEBOOK_PAGE = "https://www.facebook.com/polaris.terrain";
        public const string DISCORD = "";
        public const string STORE_PAGE = "https://assetstore.unity.com/packages/slug/286886";
        ...
        public const float MAX_TREE_DISTANCE = 2000;
        ...
        public const int CULLING_QTREE_DEPTH_MIN = 4;
        public const int CULLING_QTREE_DEPTH_MAX = 8;
        public const float CULL_BIAS_MAX = 100;
        public const float FOLIAGE_LOD_TRANSITION_MAX = 200;
        ...
        {
            Material mat = new Material(GRuntimeSettings.Instance.internalShaders.blitShader);
